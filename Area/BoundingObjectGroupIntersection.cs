...
{
    public class BoundingObjectGroupIntersection : IBoundingObjectGroup
    {
        ...
        public BoundingObjectGroupIntersection(bool isComplex = true)
        {
        ...
        public BoundingObjectGroupIntersection(IEnumerable<IBoundingObject> content, bool isComplex = true)
        {
        ...
        {
            return _content.All(boundingObject => boundingObject.ContainsEfficent(position));
        }
        ...
        private void CalculateBounds()
        {
            ...
            {
                result = result.GetIntersection(boundingObject.Bounds);
            }
